...
function MenuToggle({ id, menuIsOpen, setMenuIsOpen }: MenuToggleProps) {
  return (
    <button
      ...
      className="transition-all z-10 hover:scale-110 gap-1.5 absolute top-4 left-5 duration-200 ease-in-out h-16 w-16 rounded-full aspect-square flex flex-col justify-center items-center"
    >
      <span
